...
echo "-Line  233" >> results$1.txtecho >> results$1.txt
echo "-Line  234" >> results$1.txtecho >> results$1.txt
echo "-Line  235" >> results$1.txtecho "Should accept really long names for guests (should be OK)" >> results$1.txt
...
echo "-Line  641" >> results$1.txtecho >> results$1.txt

echo "-Line  643" >> results$1.txtecho "##Should accept really long names guest ">>results$1.txt

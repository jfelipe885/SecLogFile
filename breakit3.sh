echo "-Line  1 " echo "Test begins...\n" > results$1.txt
echo "-Line  2 " echo "Unicode tests(4 invalid)" >> results$1.txt
echo "-Line  3 " ./$1/code/build/logappend -K ? -T 2 -E emp -A logfile >> results$1.txt 
echo "-Line  4 " echo >> results$1.txt
echo "-Line  5 " ./$1/code/build/logappend -K token -T ? -E empa -A logfile >> results$1.txt
echo "-Line  6 " echo >> results$1.txt
echo "-Line  7 " ./$1/code/build/logappend -K token -T 2 -E ? -A logfile >> results$1.txt
echo "-Line  8 " echo >> results$1.txt
echo "-Line  9 " ./$1/code/build/logappend -K token -T 2 -E empb -A ? >> results$1.txt
echo "-Line  10 " echo >> results$1.txt
echo "-Line  11 " echo >> results$1.txt
echo "-Line  12 " echo "Same entry twice test(second invalid)" >> results$1.txt
echo "-Line  13 " ./$1/code/build/logappend -K token -T 2 -G guest -A logfile >> results$1.txt
echo "-Line  14 " echo >> results$1.txt
echo "-Line  15 " ./$1/code/build/logappend -K token -T 3 -G guest -A logfile >> results$1.txt
echo "-Line  16 " echo >> results$1.txt
echo "-Line  17 " echo >> results$1.txt
echo "-Line  18 " echo "Logappend to /dev/null(invalid)" >> results$1.txt
echo "-Line  19 " ./$1/code/build/logappend -T 1 -K token -E empc -A /dev/null >> results$1.txt
echo "-Line  20 " echo >> results$1.txt
echo "-Line  21 " echo >> results$1.txt
echo "-Line  22 " echo "Logread to /dev/null(invalid)" >> results$1.txt
echo "-Line  23 " echo >> results$1.txt
echo "-Line  24 " ./$1/code/build/logread -K token -S /dev/null >> results$1.txt
echo "-Line  25 " echo >> results$1.txt
echo "-Line  26 " echo >> results$1.txt
echo "-Line  27 " echo "Periods tests(should pass)" >> results$1.txt
echo "-Line  28 " ./$1/code/build/logappend -T 4 -K token -E empd -A file.log >> results$1.txt
echo "-Line  29 " echo >> results$1.txt
echo "-Line  30 " echo >> results$1.txt
echo "-Line  31 " echo "Filenames with extensions(should pass)" >> results$1.txt
echo "-Line  32 " ./$1/code/build/logappend -T 5 -K token -E empe -A file.log >> results$1.txt
echo "-Line  33 " echo >> results$1.txt
echo "-Line  34 " ./$1/code/build/logread -K token -S file.log >> results$1.txt
echo "-Line  35 " echo >> results$1.txt
echo "-Line  36 " echo >> results$1.txt
echo "-Line  37 " echo "Logappen files on current path(should pass)" >> results$1.txt
echo "-Line  38 " ./$1/code/build/logappend -T 6 -K token -E empf -A ./1 >> results$1.txt 
echo "-Line  39 " echo >> results$1.txt
echo "-Line  40 " echo >> results$1.txt
echo "-Line  41 " echo "Logread files on current path(should pass)" >> results$1.txt
echo "-Line  42 " ./$1/code/build/logappend -T 7 -K token -E empg -A ./1 >> results$1.txt 
echo "-Line  43 " echo >> results$1.txt
echo "-Line  44 " ./$1/code/build/logread -K token -S ./1 >> results$1.txt 
echo "-Line  45 " echo >> results$1.txt
echo "-Line  46 " echo >> results$1.txt
echo "-Line  47 " echo "Guest cannot enter to gallery if already in(invalid twice)" >> results$1.txt
echo "-Line  48 " ./$1/code/build/logappend -K token -T 8 -G guest -A logfile >> results$1.txt 
echo "-Line  49 " echo >> results$1.txt
echo "-Line  50 " ./$1/code/build/logappend -K token -T 9 -G guest -A logfile >> results$1.txt 
echo "-Line  51 " echo >> results$1.txt
echo "-Line  52 " echo >> results$1.txt
echo "-Line  53 " echo "Employee cannot enter to gallery if already in(second invalid)" >> results$1.txt
echo "-Line  54 " ./$1/code/build/logappend -K token -T 10 -E emp -A logfile >> results$1.txt 
echo "-Line  55 " echo >> results$1.txt
echo "-Line  56 " ./$1/code/build/logappend -K token -T 11 -E emp -A logfile >> results$1.txt 
echo "-Line  57 " echo >> results$1.txt
echo "-Line  58 " echo >> results$1.txt
echo "-Line  59 " echo "Cannot add at smaller timpestamp(second invalid)" >> results$1.txt
echo "-Line  60 " ./$1/code/build/logappend -K token -T 12 -G guesta -A logfile >> results$1.txt 
echo "-Line  61 " echo >> results$1.txt
echo "-Line  62 " ./$1/code/build/logappend -K token -T 10 -G guestb -A logfile >> results$1.txt 
echo "-Line  63 " echo >> results$1.txt
echo "-Line  64 " echo >> results$1.txt
echo "-Line  65 " echo "Invalid token(invalid)" >> results$1.txt
echo "-Line  66 " ./$1/code/build/logappend -K %hello -T 14 -G guestc -A log >> results$1.txt 
echo "-Line  67 " echo >> results$1.txt
echo "-Line  68 " echo >> results$1.txt
echo "-Line  69 " echo "Employee and guest can have the same name(second invalid)" >> results$1.txt
echo "-Line  70 " ./$1/code/build/logappend -K token -T 15 -G bob -A log >> results$1.txt 
echo "-Line  71 " echo >> results$1.txt
echo "-Line  72 " ./$1/code/build/logappend -K token -T 16 -E bob -A log >> results$1.txt 
echo "-Line  73 " echo >> results$1.txt
echo "-Line  74 " ./$1/code/build/logread -K token -S log >> results$1.txt 
echo "-Line  75 " echo >> results$1.txt
echo "-Line  76 " echo >> results$1.txt
echo "-Line  77 " echo "Test parameters order, all should work" >> results$1.txt
echo "-Line  78 " ./$1/code/build/logappend -K token -T 17 -G guestd -A logfile >> results$1.txt 
echo "-Line  79 " echo >> results$1.txt
echo "-Line  80 " ./$1/code/build/logappend -T 18 -K token -A logfile -G gueste >> results$1.txt 
echo "-Line  81 " echo >> results$1.txt
echo "-Line  82 " echo >> results$1.txt
echo "-Line  83 " echo "Cannot have both employee and guest (invalid)" >> results$1.txt
echo "-Line  84 " ./$1/code/build/logappend -K token -T 19 -G guestf -E employeea -A log >> results$1.txt 
echo "-Line  85 " echo >> results$1.txt
echo "-Line  86 " echo >> results$1.txt
echo "-Line  87 " echo "Missing logfile(invalid)" >> results$1.txt
echo "-Line  88 " ./$1/code/build/logappend -K token -T 20 -G guestg -E employeeb -A >> results$1.txt 
echo "-Line  89 " echo >> results$1.txt
echo "-Line  90 " echo >> results$1.txt
echo "-Line  91 " echo "Cannot have both arrival and departure (invalid)" >> results$1.txt
echo "-Line  92 " ./$1/code/build/logappend -K token -T 21 -E emph -A -L log >> results$1.txt 
echo "-Line  93 " echo >> results$1.txt
echo "-Line  94 " echo >> results$1.txt
echo "-Line  95 " echo "Employee cannot leave gallery without leaving room (third invalid)" >> results$1.txt
echo "-Line  96 " ./$1/code/build/logappend -K token -T 22 -E eA -A log1 >> results$1.txt 
echo "-Line  97 " echo >> results$1.txt
echo "-Line  98 " ./$1/code/build/logappend -K token -T 23 -E eA -A -R 1 log1 >> results$1.txt 
echo "-Line  99 " echo >> results$1.txt
echo "-Line  100 " ./$1/code/build/logappend -K token -T 24 -E eA -L log1 >> results$1.txt 
echo "-Line  101 " echo >> results$1.txt
echo "-Line  102 " echo >> results$1.txt
echo "-Line  103 " echo "Employee cannot leave room without being in it (second invalid)" >> results$1.txt
echo "-Line  104 " ./$1/code/build/logappend -K token -T 25 -E eB -A log1 >> results$1.txt 
echo "-Line  105 " echo >> results$1.txt
echo "-Line  106 " ./$1/code/build/logappend -K token -T 26 -E eB -L -R 1 log1 >> results$1.txt 
echo "-Line  107 " echo >> results$1.txt
echo "-Line  108 " echo >> results$1.txt
echo "-Line  109 " echo "Employee cannot arrive to another room withount first leaving it (third invalid)" >> results$1.txt
echo "-Line  110 " ./$1/code/build/logappend -K token -T 27 -E eC -A log1 >> results$1.txt 
echo "-Line  111 " echo >> results$1.txt
echo "-Line  112 " ./$1/code/build/logappend -K token -T 28 -E eC -A -R 1 log1 >> results$1.txt 
echo "-Line  113 " echo >> results$1.txt
echo "-Line  114 " ./$1/code/build/logappend -K token -T 29 -E eC -A -R 2 log1 >> results$1.txt 
echo "-Line  115 " echo >> results$1.txt
echo "-Line  116 " echo >> results$1.txt
echo "-Line  117 " echo "Employee attempt to leave room (all OK, fifth invalid)" >> results$1.txt
echo "-Line  118 " ./$1/code/build/logappend -K token -T 30 -E eD -A log1 >> results$1.txt 
echo "-Line  119 " echo >> results$1.txt
echo "-Line  120 " ./$1/code/build/logappend -K token -T 31 -E eD -A -R 1 log1 >> results$1.txt 
echo "-Line  121 " echo >> results$1.txt
echo "-Line  122 " ./$1/code/build/logappend -K token -T 32 -E eD -L -R 1 log1 >> results$1.txt 
echo "-Line  123 " echo >> results$1.txt
echo "-Line  124 " ./$1/code/build/logappend -K token -T 33 -E eD -L log1 >> results$1.txt 
echo "-Line  125 " echo >> results$1.txt
echo "-Line  126 " ./$1/code/build/logappend -K token -T 34 -E eD -L -R 1 log1 >> results$1.txt 
echo "-Line  127 " echo >> results$1.txt
echo "-Line  128 " echo >> results$1.txt
echo "-Line  129 " echo "Employee attempt to leave another room (third invalid)" >> results$1.txt
echo "-Line  130 " ./$1/code/build/logappend -K token -T 35 -E eE -A log1 >> results$1.txt 
echo "-Line  131 " echo >> results$1.txt
echo "-Line  132 " ./$1/code/build/logappend -K token -T 36 -E eE -A -R 1 log1 >> results$1.txt 
echo "-Line  133 " echo >> results$1.txt
echo "-Line  134 " ./$1/code/build/logappend -K token -T 37 -E eE -L -R 2 log1 >> results$1.txt 
echo "-Line  135 " echo >> results$1.txt
echo "-Line  136 " echo >> results$1.txt
echo "-Line  137 " echo "Guest cannot leave gallery without leaving room (third invalid)" >> results$1.txt
echo "-Line  138 " ./$1/code/build/logappend -K token -T 38 -G eF -A log1 >> results$1.txt 
echo "-Line  139 " echo >> results$1.txt
echo "-Line  140 " ./$1/code/build/logappend -K token -T 39 -G eF -A -R 1 log1 >> results$1.txt 
echo "-Line  141 " echo >> results$1.txt
echo "-Line  142 " ./$1/code/build/logappend -K token -T 40 -G eF -L log1 >> results$1.txt 
echo "-Line  143 " echo >> results$1.txt
echo "-Line  144 " echo >> results$1.txt
echo "-Line  145 " echo "Guest cannot leave room without being in it (second invalid)" >> results$1.txt
echo "-Line  146 " ./$1/code/build/logappend -K token -T 41 -G eG -A log1 >> results$1.txt 
echo "-Line  147 " echo >> results$1.txt
echo "-Line  148 " ./$1/code/build/logappend -K token -T 42 -G eG -L -R 1 log1 >> results$1.txt 
echo "-Line  149 " echo >> results$1.txt
echo "-Line  150 " echo >> results$1.txt
echo "-Line  151 " echo "Guest cannot arrive to another room whithout leaving the first (third invalid)" >> results$1.txt
echo "-Line  152 " ./$1/code/build/logappend -K token -T 43 -G eH -A log1 >> results$1.txt 
echo "-Line  153 " echo >> results$1.txt
echo "-Line  154 " ./$1/code/build/logappend -K token -T 44 -G eH -A -R 1 log1 >> results$1.txt 
echo "-Line  155 " echo >> results$1.txt
echo "-Line  156 " ./$1/code/build/logappend -K token -T 45 -G eH -A -R 2 log1 >> results$1.txt 
echo "-Line  157 " echo >> results$1.txt
echo "-Line  158 " echo >> results$1.txt
echo "-Line  159 " echo "Guest attempt to leave room again (all OK, fifth invalid)" >> results$1.txt
echo "-Line  160 " ./$1/code/build/logappend -K token -T 46 -G eI -A log1 >> results$1.txt 
echo "-Line  161 " echo >> results$1.txt
echo "-Line  162 " ./$1/code/build/logappend -K token -T 47 -G eI -A -R 1 log1 >> results$1.txt 
echo "-Line  163 " echo >> results$1.txt
echo "-Line  164 " ./$1/code/build/logappend -K token -T 48 -G eI -L -R 1 log1 >> results$1.txt 
echo "-Line  165 " echo >> results$1.txt
echo "-Line  166 " ./$1/code/build/logappend -K token -T 49 -G eI -L log1 >> results$1.txt 
echo "-Line  167 " echo >> results$1.txt
echo "-Line  168 " ./$1/code/build/logappend -K token -T 50 -G eI -L -R 1 log1 >> results$1.txt 
echo "-Line  169 " echo >> results$1.txt
echo "-Line  170 " echo >> results$1.txt
echo "-Line  171 " echo "Guest attempt to leave another room (third invalid)" >> results$1.txt
echo "-Line  172 " ./$1/code/build/logappend -K token -T 51 -G eJ -A log1 >> results$1.txt 
echo "-Line  173 " echo >> results$1.txt
echo "-Line  174 " ./$1/code/build/logappend -K token -T 52 -G eJ -A -R 1 log1 >> results$1.txt 
echo "-Line  175 " echo >> results$1.txt
echo "-Line  176 " ./$1/code/build/logappend -K token -T 53 -G eJ -L -R 2 log1 >> results$1.txt 
echo "-Line  177 " echo >> results$1.txt
echo "-Line  178 " echo >> results$1.txt
echo "-Line  179 " echo "Cannot leave room without being in it (invalid)" >> results$1.txt
echo "-Line  180 " ./$1/code/build/logappend -K token -T 54 -G eK -L -R 2 log1 >> results$1.txt 
echo "-Line  181 " echo >> results$1.txt
echo "-Line  182 " echo >> results$1.txt
echo "-Line  183 " echo "Cannot leave gallery without being in it (invalid)" >> results$1.txt
echo "-Line  184 " ./$1/code/build/logappend -K token -T 55 -G eL -L log1 >> results$1.txt 
echo "-Line  185 " echo >> results$1.txt
echo "-Line  186 " echo >> results$1.txt
echo "-Line  187 " echo "Should print error on non existent batch (invalid)" >> results$1.txt
echo "-Line  188 " ./$1/code/build/logappend -B foo >> results$1.txt 
echo "-Line  189 " echo >> results$1.txt
echo "-Line  190 " echo >> results$1.txt
echo "-Line  191 " echo "Cannot have non numeric room (third invalid)" >> results$1.txt
echo "-Line  192 " ./$1/code/build/logappend -K token -T 56 -E baseA -A log1 >> results$1.txt 
echo "-Line  193 " echo >> results$1.txt
echo "-Line  194 " ./$1/code/build/logappend -K token -T 57 -G guestH -A -R 1 log1 >> results$1.txt 
echo "-Line  195 " echo >> results$1.txt
echo "-Line  196 " ./$1/code/build/logappend -K token -T 58 -G guestI -A -R foo log1 >> results$1.txt 
echo "-Line  197 " echo >> results$1.txt
echo "-Line  198 " echo >> results$1.txt
echo "-Line  199 " echo "Room 2, 02, 002 should all be 2 (15 guests first 4 in room 2)" >> results$1.txt
echo "-Line  200 " ./$1/code/build/logappend -K token -T 59 -G gA -A log1 >> results$1.txt 
echo "-Line  201 " echo >> results$1.txt
echo "-Line  202 " ./$1/code/build/logappend -K token -T 60 -G gB -A log1 >> results$1.txt 
echo "-Line  203 " echo >> results$1.txt
echo "-Line  204 " ./$1/code/build/logappend -K token -T 61 -G gC -A log1 >> results$1.txt 
echo "-Line  205 " echo >> results$1.txt
echo "-Line  206 " ./$1/code/build/logappend -K token -T 62 -G gD -A log1 >> results$1.txt 
echo "-Line  207 " echo >> results$1.txt
echo "-Line  208 " ./$1/code/build/logappend -K token -T 63 -G gE -A log1 >> results$1.txt 
echo "-Line  209 " echo >> results$1.txt
echo "-Line  210 " ./$1/code/build/logappend -K token -T 64 -G gF -A log1 >> results$1.txt 
echo "-Line  211 " echo >> results$1.txt
echo "-Line  212 " ./$1/code/build/logappend -K token -T 65 -G gG -A log1 >> results$1.txt 
echo "-Line  213 " echo >> results$1.txt
echo "-Line  214 " ./$1/code/build/logappend -K token -T 66 -G gH -A log1 >> results$1.txt 
echo "-Line  215 " echo >> results$1.txt
echo "-Line  216 " ./$1/code/build/logappend -K token -T 67 -G gI -A log1 >> results$1.txt 
echo "-Line  217 " echo >> results$1.txt
echo "-Line  218 " ./$1/code/build/logappend -K token -T 68 -G gJ -A log1 >> results$1.txt 
echo "-Line  219 " echo >> results$1.txt
echo "-Line  220 " ./$1/code/build/logappend -K token -T 69 -G gA -A -R 2 log1 >> results$1.txt 
echo "-Line  221 " echo >> results$1.txt
echo "-Line  222 " ./$1/code/build/logappend -K token -T 70 -G gB -A -R 02 log1 >> results$1.txt 
echo "-Line  223 " echo >> results$1.txt
echo "-Line  224 " ./$1/code/build/logappend -K token -T 71 -G gC -A -R 002 log1 >> results$1.txt 
echo "-Line  225 " echo >> results$1.txt
echo "-Line  226 " ./$1/code/build/logappend -K token -T 72 -G gD -A -R 0 log1 >> results$1.txt 
echo "-Line  227 " echo >> results$1.txt
echo "-Line  228 " ./$1/code/build/logread -K token -S log1 >> results$1.txt 
echo "-Line  229 " echo >> results$1.txt
echo "-Line  230 " echo >> results$1.txt
echo "-Line  231 " echo "Should accept really long names for employees (should be OK)" >> results$1.txt
...
echo "-Line  233 " echo >> results$1.txt
echo "-Line  234 " echo >> results$1.txt
echo "-Line  235 " echo "Should accept really long names for guests (should be OK)" >> results$1.txt
...
echo "-Line  641 " echo >> results$1.txt

echo "-Line  643 " echo "##Should accept really long names guest ">>results$1.txt
